...
from LeaderMusic.Modules import ALL_MODULES


async def fallen_startup():
    LOGGER.info("[•] Loading Modules...")
    for module in ALL_MODULES:
        importlib.import_module("LeaderMusic.Modules." + module)
...
if __name__ == "__main__":
    ...
    LOGGER.error("Leader Music Bot Stopped.")
